                    ...
                    }
                    {
                        ...
                        && (
                            <div className='flex-1 md:flex flex-col mt-5 justify-center items-center duration-1000 transition-all'>
                                ...
                                />
                                <div className='text-opacity-80 text-white flex flex-col gap-5 items-center m-5 lg:text-2xl text-xl transition-all duration-300 text-center'>
                                    <h3 className='poppins-medium'>
                                        Search new
                                        <span className='text-[#5ce1e6]'> Contact. </span>
                                    </h3>
                                </div>
                            </div>
                        )}
