...
const MessageContainer = () =>
{
        ...
        message.messageType === "text" && (
          <div
            className={`${message.sender !== selectedChatData._id
              ? "bg-[#8417ff]/5 text-white/80 border-white/20"
      ...
      <div className={`mt-5 ${message.sender._id !== userInfo.id ? "text-left" : "text-right"}`}>
        ...
        }
        {
          message.sender._id !== userInfo.id ? <div className='flex items-center justify-start gap-3'>
            <Avatar className=" flex h-8 w-8 rounded-full overflow-hidden ">
              {
  ...
  return (
    <div className='flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full'>
      ...
      <div ref={scrollRef} />
      {
        showImage && <div className='fixed z-[1000] top-0 left-0 h-screen w-screen flex items-center justify-center backdrop-blur-lg flex-col' >
          <div>
            <img src={`${HOST}/${imageURL}`}
              className='h-[80vh] w-full bg-cover' />
          </div>
          <div className='flex gap-4 fixed bottom-[10px] mt-5'>
